...
from app.vendor.boxmot.trackers.detection_layout import (get_detection_layout,
                                              infer_detection_layout)
from app.vendor.boxmot.utils import logger as LOGGER
from app.vendor.boxmot.utils.iou import AssociationFunction
from app.vendor.boxmot.utils.visualization import VisualizationMixin
...
class BaseTracker(VisualizationMixin):
    ...
    def get_track_state_for_display(self, track):
        ...
        if hasattr(track, "state"):
            try:
                from app.vendor.boxmot.trackers.botsort.basetrack import TrackState
