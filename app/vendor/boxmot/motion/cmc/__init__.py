...
_CMC_REGISTRY: Mapping[str, Callable[[], Type[BaseCMC]]] = {
    "ecc": _LazyLoader("app.vendor.boxmot.motion.cmc.ecc", "ECC"),
    "orb": _LazyLoader("app.vendor.boxmot.motion.cmc.orb", "ORB"),
    "sof": _LazyLoader("app.vendor.boxmot.motion.cmc.sof", "SOF"),
    "sift": _LazyLoader("app.vendor.boxmot.motion.cmc.sift", "SIFT"),
}
